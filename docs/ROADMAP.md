...
| **0.2.0** | **Idle Scheduling** | `idle` strategy, `IdleScheduler` cross-runtime abstraction (`requestIdleCallback`, `setImmediate`, `setTimeout`), cancellation during idle wait, `ahko.idle()` convenience API. | **In Progress 🎯** |
